<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/bd196cf1072f48afae5676066a72e297.jpg) fixed no-repeat center top / 100% 100%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="笔记类型" prop="bijileixing">
					<el-input v-model="ruleForm.bijileixing" placeholder="笔记类型" clearable  :readonly="ro.bijileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="笔记类型" prop="bijileixing">
					<el-input v-model="ruleForm.bijileixing" placeholder="笔记类型" readonly></el-input>
				</el-form-item>
			</template>
